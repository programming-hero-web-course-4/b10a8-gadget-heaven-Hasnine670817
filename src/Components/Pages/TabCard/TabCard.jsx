...
const TabCard = ({card}) => {
    ...
    const {product_title, price} = card;
    ...
    return (
        <div className='bg-white p-5 rounded-2xl flex flex-col'>
            ...
            <div>
                <Link className='btn btn-outline border-[#9538E2] rounded-[32px] h-auto min-h-auto py-3 px-5 text-[#9538E2] mt-4'>View Details</Link>
            </div>
        </div>
    );
};
